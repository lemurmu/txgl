...
namespace BizUtils.Data
{
    public static class EcanConvertToCh
    {
        ...
        public static string ConvertCh_G(string Chstr)
        {
            Regex reg = new Regex("^[\u4e00-\u9fa5]$");//验证是否输入汉字
            byte[] arr = new byte[2];
            string pystr = "";
            ...
            for (int j = 0; j < mChar.Length; j++)
            {
                ...
                if (reg.IsMatch(mChar[j].ToString()))
                {
                    ...
                    else
                    {
                        ...
                        {
                            case -9254:
                                pystr += "Zhen".Substring(0, 1); break;
                            case -8985:
                                pystr += "Qian".Substring(0, 1); break;
                            case -5463:
                                pystr += "Jia".Substring(0, 1); break;
                            case -8274:
                                pystr += "Ge".Substring(0, 1); break;
                            case -5448:
                                pystr += "Ga".Substring(0, 1); break;
                            case -5447:
                                pystr += "La".Substring(0, 1); break;
                            case -4649:
                                pystr += "Chen".Substring(0, 1); break;
                            case -5436:
                                pystr += "Mao".Substring(0, 1); break;
                            case -5213:
                                pystr += "Mao".Substring(0, 1); break;
                            case -3597:
                                pystr += "Die".Substring(0, 1); break;
                            case -5659:
                                pystr += "Tian".Substring(0, 1); break;
                            default:
                                for (int i = (getValue.Length - 1); i >= 0; i--)
                                {
                                    if (getValue[i] <= asc)//判断汉字的拼音区编码是否在指定范围内
