...
namespace CommonFunction
{
    public class ExcelHelper
    {
        ...
        public void ExportDTtoExcel(DataTable dtSource, string strFileName, string strHeaderText = null)
        {
        ...
        public int GetSheetNumber(string outputFile)
        {
            ...
            try
            {
                ...
                XSSFWorkbook XSSFWorkbook = new XSSFWorkbook(readfile);
                number = XSSFWorkbook.NumberOfSheets;
        ...
        public ArrayList GetSheetName(string outputFile)
        {
            ...
            try
            {
                ...
                IWorkbook XSSFWorkbook =  GetworkBook(outputFile);
